...
public class createNetwrokAsync extends AsyncTask<String, Void, String> {

	Context ctx;
	//AlertDialog alertDialog;
	 private Dialog loadingDialog;
	
     public createNetwrokAsync(Context ctx) {
		super();
		this.ctx = ctx;
	...
	protected void onPreExecute() {
		...
		super.onPreExecute();
		  loadingDialog = ProgressDialog.show(ctx, "Please wait", "Creating.....");
	} //onPreExecute
	...
	protected String doInBackground(String... params) {
		// TODO Auto-generated method stub
		String response="";
		String loginUrl="http://www.website4fooddelivery.in/securityalarm/createNetwork.php";
	...
	protected void onPostExecute(String result) {
		...
		Toast.makeText(ctx, "network created successfully", Toast.LENGTH_SHORT).show();
